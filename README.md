...
| <a name="input_ami_filters"></a> [ami\_filters](#input\_ami\_filters) | AMI filters | <pre>object({<br>    enabled            = optional(bool, false)<br>    executable_users   = optional(list(string), null)<br>    include_deprecated = optional(bool, false)<br>    most_recent        = optional(bool, true)<br>    owners             = optional(list(string), ["amazon"])<br>    filter             = optional(any, {})<br>  })</pre> | `{}` | no |
